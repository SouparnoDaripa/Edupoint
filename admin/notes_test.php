...
$(function()
{
  ...
  <script>
      ...
      function upload_note(){
        ...
        var desc = $('#redactor').redactor('code.get');
          var ajax = ajaxObj("POST", "notes_test.php");
    ...
    <div class="page-header section-heading">
       ...
       <div class="well">
            ...
            <form class= "form-horizontal" onsubmit="return false;">
                ...
                <input type ="submit" class="btn btn-primary btn-raised" onclick="upload_note()" value="Save" />
            </form>
            </div>
      </div>
      </div>