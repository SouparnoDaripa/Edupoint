    ...
    ?>
     ...
     <div class="container">
        <div class="page-header text-center">
            <h2 class="section-header" id="topics">Featured Topics</h2>
        </div>
        <?php
        if(isset($_GET["subject_of"])){
           ...
           echo '<div class="row">
            <div class="col-md-12">
                ...
                $query= "SELECT * from subject WHERE subject_of = '$subject_of' AND isTopic = 1";
                    ...
                    while($row= mysqli_fetch_array($result)){
                        echo '<div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="well subject-box text-center">
                                ...
                                <h4><a href="topic_lectures.php?sub_id='.$row[0].'">'.$row[3].'</a></h4>
                            </div>
                        </div>';
                    }
                echo '</div>';
            ...
            $query= "SELECT subject_of from subject  where isTopic = 1 order by subject_of";
            $result= mysqli_query($db_conx, $query);
            while($row= mysqli_fetch_array($result)){
            $subject_of= $row[0];
            echo'
            <div class="row">
                <div class="col-md-12">
                    ...
                    $query1= "SELECT * from subject WHERE subject_of = '$subject_of' AND isTopic = 1";
                    $result1= mysqli_query($db_conx, $query1);
                    while($row1= mysqli_fetch_array($result1)){
                        echo '<div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="well subject-box text-center">
                                <img src="image/'.$row1[4].'" class="img-responsive" alt="">
                                <h4><a href="topic_lectures.php?sub_id='.$row1[0].'">'.$row1[3].'</a></h4>
                            </div>
                        </div>';
